...
export const RESET_MEALS_MESSAGE = 'Do you want to reset all weekly menu meals?'
...
export const HELP_ICON_EXPLANATION_2 = ' up to the right, where you will find some info about the functionality.'
...
export const HOW_TO_SELECT_RECIPE = '\u2023 To SELECT a recipe for the lunch/dinner:'
export const HOW_TO_ADD_INGREDIENTS_GROCERY_LIST = '\u2023 To ADD the ingredients of the recipe to the grocery list:'
