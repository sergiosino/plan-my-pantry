...
export const HELP_ICON_EXPLANATION_2 = ' icon in the right of the header, where you will find some info about the functionality.'
...
export const SHOW_HELP_ICON_2 = ' icon in pages header'
